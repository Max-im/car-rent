...
import { Transition, Listbox, ListboxButton, ListboxOption, ListboxOptions } from '@headlessui/react';
import { CustomFilterProps } from '@/types'
import { updateSearchParams } from '@/utils';

export default function CustomFilter({ title, payload }: CustomFilterProps) {
  const router = useRouter();
  const [selected, setSelected] = useState(payload[0])
